  ...
  return (
    <div className={s.actual_order}>
      ...
      <div className={s.actual_order_wrapper}>
        <div className={s.actual_order_item}>
          <img className={s.actual_order_item_image} src={Rectangle1} alt="" />
        ...
        <div className={s.actual_order_item}>
          <img className={s.actual_order_item_image} src={Rectangle2} alt="" />
          <div className={s.actual_order_item_title_wrapper}>
        ...
        <div className={s.actual_order_item}>
          ...
          <img className={s.actual_order_item_image} src={Rectangle3} alt="" />
          <div className={s.actual_order_item_title_wrapper}>
            <p className={s.actual_order_item_title}>
        ...
        <div className={s.actual_order_item}>
          <p className={s.new}>NEW</p>
          <img className={s.actual_order_item_image} src={Rectangle4} alt="" />
          <div className={s.actual_order_item_title_wrapper}>
            <p className={s.actual_order_item_title}>
