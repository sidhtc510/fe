    ...
    <div className={s.product}>
      ...
      <div className={s.priceAndControlWrapper}>
        ...
        <div className={s.control}>
          <button onClick={() => dispatch(INCREMENTBascketAction(id))}>
            +
          </button>
          <button onClick={() => dispatch(DECREMENTBascketAction(id))}>
            -
          </button>
        </div>
        <button onClick={()=>dispatch(deleteItemBascketAction(id))}>X</button>
      </div>
    </div>
  );
}
